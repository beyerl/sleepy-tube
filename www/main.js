...
const routes = [
    {
        path: 'player',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_player_player_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./player/player.module */ 8133)).then(m => m.PlayerPageModule)
    },
    {
        path: 'message/:id',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_view-message_view-message_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./view-message/view-message.module */ 8164)).then(m => m.ViewMessagePageModule)
    },
    {
        path: '',
        redirectTo: 'player',
